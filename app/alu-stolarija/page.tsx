            ...
            <AnimatedSection>
              <div>
                ...
                <p className="text-lg mb-4">
                  Standard sistem vrhunskih performansi. Idealan za objekte sa
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <AnimatedSection>
              <div className="order-2 md:order-1">
                ...
                <p className="text-lg mb-4">
                  Premium klizni sistem sa termoprekidom. Idealan za terase,
                  balkone i velike staklene površine.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <AnimatedSection>
              <div>
                ...
                <p className="text-lg mb-4">
                  Standard klizni sistem. Optimalan odnos cene i kvaliteta.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          <AnimatedSection>
            ...
            <p className="text-lg md:text-xl mb-8">
              ALU stolarija može biti proizvedena u širokoj paleti boja i
              završnih obrada:
            </p>
          </AnimatedSection>
